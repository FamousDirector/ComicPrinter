...
class ComicPrinter:
    ...
    def update_screen(self):
        with canvas(self.screen) as draw:
            ...
            draw.text((5, 5), self.comic_name_array[self.comic_index], fill="white")
    ...
    def __init__(self):
        ...
        GPIO.add_event_detect(self.clk_pin, GPIO.FALLING, callback=self.change_comic_callback, bouncetime=5)
